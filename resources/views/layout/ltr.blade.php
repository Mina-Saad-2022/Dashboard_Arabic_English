...
<head>
    ...
    <!--- Style css -->
    @if (App::getLocale() == 'en')
        <link rel="stylesheet" href="{{asset('assets/admin/dist/css/ltr.css')}}">
    @else
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        ...
        <ul class="  navbar-nav ml-auto">
            ...
            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                <li>
                    <a rel="alternate" class="p-2 text-white" hreflang="{{ $localeCode }}"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="margin-right dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="margin-right nav-item">
